        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 lg:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4">
              <img src="/logo.png" alt="InAmigos Logo" className="h-10 w-auto object-contain" />
              <div>
                <span className="font-bold text-xl block leading-none">InAmigos</span>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.name}>
                  <Link to={link.path} className="text-sm font-medium hover:text-primary transition-colors">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/get-involved" className="text-sm font-medium hover:text-primary transition-colors">
                  Become a Volunteer
                </Link>
              </li>
              <li>
