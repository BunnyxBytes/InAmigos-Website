    ...
    <div>
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            InAmigos Foundation works towards education, youth empowerment, and community development to build a better and brighter tomorrow for all.
          </motion.p>
          <motion.div
          ...
          >
            <Link to="/get-involved" className="px-8 py-4 bg-secondary text-gray-900 font-bold rounded-md hover:bg-yellow-400 transition-colors inline-flex justify-center items-center">
              Become a Volunteer
            </Link>
              ...
              <div className="space-y-4 text-gray-600 font-medium">
                ...
                <div className="flex items-start gap-4 mt-6 p-4 bg-primary/5 rounded-xl border border-primary/10">
                  ...
                  <p className="text-primary font-semibold">
                    On 28 March 2021, InAmigos Foundation officially began its journey to serve society and empower communities through youth-led initiatives.
                  </p>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center flex-row-reverse">
            ...
            >
              <img src="https://images.unsplash.com/photo-1559027615-cd4628902d4a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="InAmigos Impact" className="rounded-2xl shadow-xl" />
      ...
      <section className="relative py-24 bg-gray-900 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          >
            <Link to="/get-involved" className="px-10 py-5 bg-white text-primary font-bold rounded-full shadow-lg hover:bg-gray-50 hover:shadow-xl transition-all duration-300 inline-block text-lg">
